...
FIND_PATH(CAIRO_INCLUDE_DIR NAMES cairo.h HINTS ${_CAIRO_INCLUDEDIR} ${_CAIRO_ROOT_HINTS_AND_PATHS} PATH_SUFFIXES include "include/cairo")
...
ELSE(WIN32 AND NOT CYGWIN)
  ...
  FIND_LIBRARY(CAIRO_LIBRARYNAMES cairo HINTS ${_CAIRO_LIBDIR} ${_CAIRO_ROOT_HINTS_AND_PATHS} PATH_SUFFIXES "lib" "local/lib")
...
find_package_handle_standard_args(CAIRO "Could NOT find CAIRO, try to set the path to CAIRO root folder in the system variable CAIRO" CAIRO_LIBRARIES CAIRO_INCLUDE_DIR)
